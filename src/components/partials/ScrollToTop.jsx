  ...
  return (
    show && (
      <button
        ...
        className={`lg:bottom-18 bottom-16 right-5 rounded-full bg-gray-50/80 p-3.5 text-gray-900 shadow-[0_16px_30px_rgb(0,0,0,0.12)] backdrop-blur-2xl hover:bg-gray-200/80 dark:bg-gray-800/60 dark:text-gray-100 dark:hover:bg-gray-600/60 md:right-8 lg:right-12 ${scrollToTopBtn}`}
      >
